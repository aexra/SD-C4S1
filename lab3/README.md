...
|----|----------|---------|---------|---------|---------|---------|
| 1.1 | Анализ требований | 3 | 5 | 7 | 5 | Студент |
| 1.2 | Определение целей и задач проекта | 2 | 3 | 4 | 3 | Студент |
| 1.3 | Определение заинтересованных сторон | 1 | 2 | 3 | 2 | Студент |
| 1.4 | Разработка чартера проекта | 2 | 3 | 5 | 3.2 | Студент, руководитель |

### 2. Планирование проекта
| ID | Название | O (дни) | M (дни) | P (дни) | E (дни) | Ресурсы |
|----|----------|---------|---------|---------|---------|---------|
| 2.1 | Разработка плана управления проектом | 3 | 5 | 7 | 5 | Студент |
| 2.2 | Определение состава команды | 1 | 2 | 3 | 2 | Студент, руководитель |
| 2.3 | Планирование сроков и бюджета | 4 | 6 | 8 | 6 | Студент, руководитель |
| 2.4 | Определение рисков проекта | 3 | 4 | 6 | 4.2 | Студент, руководитель |

### 3. Анализ и проектирование системы
| ID | Название | O (дни) | M (дни) | P (дни) | E (дни) | Ресурсы |
|----|----------|---------|---------|---------|---------|---------|
| 3.1 | Изучение существующих решений | 5 | 7 | 10 | 7.2 | Студент |
| 3.2 | Анализ архитектуры Greenplum | 4 | 6 | 9 | 6.2 | Студент |
| 3.3 | Анализ Apache Airflow | 3 | 5 | 7 | 5 | Студент |
| 3.4 | Анализ MinIO | 3 | 4 | 6 | 4.2 | Студент |
| 3.5 | Проектирование архитектуры системы | 5 | 7 | 10 | 7.2 | Студент, руководитель |
| 3.6 | Проектирование веб-интерфейса | 4 | 6 | 8 | 6 | Студент |
| 3.7 | Проектирование системы мониторинга | 4 | 5 | 7 | 5.2 | Студент |
| 3.8 | Проектирование системы отчетов | 3 | 5 | 7 | 5 | Студент |

### 4. Разработка веб-интерфейса
| ID | Название | O (дни) | M (дни) | P (дни) | E (дни) | Ресурсы |
|----|----------|---------|---------|---------|---------|---------|
| 4.1 | Создание прототипов интерфейса | 3 | 5 | 7 | 5 | Студент |
| 4.2 | Разработка фронтенд-компонентов | 8 | 12 | 16 | 12 | Студент |
| 4.3 | Разработка бэкенд-сервера | 10 | 15 | 20 | 15 | Студент |
| 4.4 | Интеграция системой аутентификации (Keycloak/LDAP) | 5 | 7 | 10 | 7.2 | Студент |

### 5. Реализация системы автоматического развертывания
| ID | Название | O (дни) | M (дни) | P (дни) | E (дни) | Ресурсы |
|----|----------|---------|---------|---------|---------|---------|
| 5.1 | Разработка скриптов развертывания | 7 | 10 | 14 | 10.2 | Студент |
| 5.2 | Интеграция с Greenplum | 8 | 12 | 16 | 12 | Студент |
| 5.3 | Интеграция с Apache Airflow | 6 | 9 | 12 | 9 | Студент |
| 5.4 | Интеграция с MinIO | 5 | 7 | 10 | 7.2 | Студент |
| 5.5 | Тестирование развертывания | 4 | 6 | 8 | 6 | Студент |

### 6. Реализация системы мониторинга
| ID | Название | O (дни) | M (дни) | P (дни) | E (дни) | Ресурсы |
|----|----------|---------|---------|---------|---------|---------|
| 6.1 | Интеграция с Prometheus | 4 | 6 | 8 | 6 | Студент |
| 6.2 | Интеграция с Grafana | 3 | 5 | 7 | 5 | Студент |
| 6.3 | Разработка дополнительных метрик | 6 | 8 | 11 | 8.2 | Студент |
| 6.4 | Визуализация метрик в веб-интерфейсе | 5 | 7 | 9 | 7 | Студент |

### 7. Реализация генератора отчетов
| ID | Название | O (дни) | M (дни) | P (дни) | E (дни) | Ресурсы |
|----|----------|---------|---------|---------|---------|---------|
| 7.1 | Разработка системы шаблонов отчетов | 6 | 8 | 12 | 8.3 | Студент |
| 7.2 | Создание графов потоков данных | 7 | 10 | 14 | 10.2 | Студент |
| 7.3 | Реализация системы управления правами доступа | 5 | 7 | 10 | 7.2 | Студент |
| 7.4 | Тестирование функционала отчетов | 4 | 6 | 8 | 6 | Студент |

### 8. Тестирование системы
| ID | Название | O (дни) | M (дни) | P (дни) | E (дни) | Ресурсы |
|----|----------|---------|---------|---------|---------|---------|
| 8.1 | Модульное тестирование | 5 | 7 | 10 | 7.2 | Студент |
| 8.2 | Интеграционное тестирование | 6 | 8 | 12 | 8.3 | Студент |
| 8.3 | Системное тестирование | 5 | 7 | 9 | 7 | Студент |
| 8.4 | Тестирование пользовательского интерфейса | 4 | 6 | 8 | 6 | Студент, руководитель |

### 9. Документирование
| ID | Название | O (дни) | M (дни) | P (дни) | E (дни) | Ресурсы |
|----|----------|---------|---------|---------|---------|---------|
| 9.1 | Создание технической документации | 4 | 6 | 8 | 6 | Студент |
| 9.2 | Создание пользовательской документации | 5 | 7 | 10 | 7.2 | Студент |
| 9.3 | Создание руководства администратора | 4 | 6 | 9 | 6.2 | Студент |
| 9.4 | Создание приложения БЖД | 3 | 5 | 7 | 5 | Студент |
| 9.5 | Создание приложения экономики | 4 | 6 | 8 | 6 | Студент |

### 10. Внедрение и сдача проекта
| ID | Название | O (дни) | M (дни) | P (дни) | E (дни) | Ресурсы |
|----|----------|---------|---------|---------|---------|---------|
| 10.1 | Получение рекомендации руководителя | 3 | 4 | 6 | 4.2 | Студент |
| 10.2 | Нормаконтроль | 2 | 3 | 4 | 3 | Студент, руководитель |
| 10.3 | Антиплагиат | 5 | 7 | 10 | 7.2 | Студент |
| 10.4 | Предзащита | 3 | 5 | 7 | 5 | Руководитель |
| 10.5 | Защита | 7 | 10 | 14 | 10.2 | Студент |
...
### Описание ресурсов:
- Студент (разработчик): основной исполнитель проекта
...
|----|----------|---------|------------------|----------------|
| 1.1 | Анализ требований | Студент | Анализ и документирование требований | 100% |
| 1.2 | Определение целей и задач проекта | Студент | Формулирование целей и задач | 10% |
| 1.3 | Определение заинтересованных сторон | Студент | Идентификация и анализ заинтересованных сторон | 100% |
| 1.4 | Разработка чартера проекта | Студент, руководитель | Разработка: Студент; одобрение: руководитель | Студент - 80%, руководитель - 20% |
| 2.1 | Разработка плана управления проектом | Студент | Планирование всех аспектов управления проектом | 100% |
| 2.2 | Определение состава команды | Студент, руководитель | Определение: Студент; одобрение: руководитель | Студент - 70%, руководитель - 30% |
| 2.3 | Планирование сроков и бюджета | Студент, руководитель | Планирование: Студент; одобрение: руководитель | Студент - 80%, руководитель - 20% |
| 2.4 | Определение рисков проекта | Студент, руководитель | Идентификация: Студент; оценка: руководитель | Студент - 60%, руководитель - 40% |
| 3.1 | Изучение существующих решений | Студент | Исследование и анализ аналогов | 100% |
| 3.2 | Анализ архитектуры Greenplum | Студент | Технический анализ архитектуры | 100% |
| 3.3 | Анализ Apache Airflow | Студент | Технический анализ архитектуры | 100% |
| 3.4 | Анализ MinIO | Студент | Технический анализ архитектуры | 100% |
| 3.5 | Проектирование архитектуры системы | Студент, руководитель | Проектирование: Студент; одобрение: руководитель | Студент - 90%, руководитель - 10% |
| 3.6 | Проектирование веб-интерфейса | Студент | Проектирование пользовательского интерфейса | 100% |
| 3.7 | Проектирование системы мониторинга | Студент | Проектирование архитектуры мониторинга | 100% |
| 3.8 | Проектирование системы отчетов | Студент | Проектирование системы отчетов | 100% |
| 4.1 | Создание прототипов интерфейса | Студент | Разработка прототипов | 100% |
| 4.2 | Разработка фронтенд-компонентов | Студент | Разработка клиентской части | 100% |
| 4.3 | Разработка бэкенд-сервера | Студент | Разработка серверной части | 100% |
| 4.4 | Интеграция системой аутентификации | Студент | Интеграция с Keycloak/LDAP | 100% |
| 5.1 | Разработка скриптов развертывания | Студент | Разработка скриптов автоматизации | 10% |
| 5.2 | Интеграция с Greenplum | Студент | Интеграция с базой данных | 100% |
| 5.3 | Интеграция с Apache Airflow | Студент | Интеграция с ETL-системой | 100% |
| 5.4 | Интеграция с MinIO | Студент | Интеграция с хранилищем объектов | 100% |
| 5.5 | Тестирование развертывания | Студент | Проверка работоспособности развертывания | 100% |
| 6.1 | Интеграция с Prometheus | Студент | Интеграция с системой мониторинга | 100% |
| 6.2 | Интеграция с Grafana | Студент | Интеграция с системой визуализации | 10% |
| 6.3 | Разработка дополнительных метрик | Студент | Разработка специфических метрик | 100% |
| 6.4 | Визуализация метрик в веб-интерфейсе | Студент | Интеграция метрик в интерфейс | 100% |
| 7.1 | Разработка системы шаблонов отчетов | Студент | Разработка системы шаблонов | 100% |
| 7.2 | Создание графов потоков данных | Студент | Создание визуальных представлений потоков | 100% |
| 7.3 | Реализация системы управления правами доступа | Студент | Реализация системы авторизации | 100% |
| 7.4 | Тестирование функционала отчетов | Студент | Тестирование системы отчетов | 100% |
| 8.1 | Модульное тестирование | Студент | Тестирование отдельных модулей | 100% |
| 8.2 | Интеграционное тестирование | Студент | Тестирование взаимодействия компонентов | 100% |
| 8.3 | Системное тестирование | Студент | Комплексное тестирование системы | 100% |
| 8.4 | Тестирование пользовательского интерфейса | Студент, руководитель | Тестирование: Студент; одобрение: руководитель | Студент - 80%, руководитель - 20% |
| 9.1 | Создание технической документации | Студент | Написание технической документации | 100% |
| 9.2 | Создание пользовательской документации | Студент | Написание пользовательской документации | 10% |
| 9.3 | Создание руководства администратора | Студент | Написание руководства администратора | 100% |
| 9.4 | Создание приложения БЖД | Студент | Написание приложения по безопасности жизедеятельности | 100% |
| 9.5 | Создание приложения экономики | Студент | Написание приложения по экономике | 10% |
| 10.1 | Получение рекомендации руководителя | Студент | Получение рекомендации руководителя | 100% |
| 10.2 | Нормаконтроль | Студент, руководитель | Презентация: Студент; оценка: руководитель | Студент - 70%, руководитель - 30% |
| 10.3 | Антиплагиат | Студент | Подготовка и сдача работы | 10% |
| 10.4 | Предзащита | Руководитель | Написание и выдача отзыва | 100% |
| 10.5 | Защита | Студент | Подготовка презентации и ответов | 10% |

### Загрузка ресурсов:
- Студент (разработчик): Участвует во всех фазах проекта, основная нагрузка (~95% задач)
...
- Основной исполнитель: Студент (разработчик) - участвует во всех фазах проекта
